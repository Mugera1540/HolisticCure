  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-[999]">
      ...
      <motion.a
        ...
        className={`${buttonBase} bg-[#25D366] text-white`}
      ...
      <motion.a
        ...
        className={`${buttonBase} bg-white text-[var(--color-emerald-deep)] border border-emerald-deep/10`}
        aria-label="Contact via Email"
      >
        <MailIcon size={24} className="sm:w-7 sm:h-7" />
      </motion.a>
    </div>
  );
}
